...
- 新版 Figure 3 已单独生成在 `figures/fig3_ablation_routing.{png,pdf}`，不改动正文引用或文字；Figure 3a 补齐 Geometry × Routing 四组合，Figure 3d 覆盖 0°、15°、25°、35°、45°、60° 的完整透视与 identity-fallback 扫描。
